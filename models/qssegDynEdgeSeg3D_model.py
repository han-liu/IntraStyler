...
class QSSEGDYNEDGESEG3DModel(BaseModel):
    @staticmethod
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'D_real', 'D_fake', 'G', 'NCE', 'DiceA', 'DiceB', 'sobelL1']#, 'tumor']
    ...
    def backward_G(self):
        ...
        # self.loss_tumor = self.calculate_tumor_loss(self.fake_B, self.real_A_mask)
        self.loss_G = self.loss_G_GAN + loss_NCE_both + self.loss_DiceA + self.loss_DiceB + self.loss_sobelL1 #+ self.loss_tumor
    ...
    def update_segB_lambda(self, epochNum):
        if epochNum <= 500:
            self.opt.lambda_segB = 0
        elif epochNum > 500 and epochNum < 1000:
            self.opt.lambda_segB = 0.75
        elif epochNum > 1000 and epochNum < 1500:
            self.opt.lambda_segB = 1
        elif epochNum > 1500:
