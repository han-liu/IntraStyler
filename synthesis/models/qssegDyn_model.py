...
from . import networks_global_seg, networks_local, networks_local_global
...
class QSSEGDYNModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        assert opt.netG == 'resnet_9blocks_dyn'
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'D_real', 'D_fake', 'G', 'NCE', 'DiceA']
        self.visual_names = ['real_A', 'fake_B', 'real_B', 'real_A_mask', 'seg_A']
    ...
    def backward_D(self):
        if self.opt.lambda_GAN > 0.0:
            ...
            fake = self.fake_B.detach()  # 1 x 1 x 320 x 320
            # Fake; stop backprop to the generator by detaching fake_B
            pred_fake = self.netD(fake)  # 1 x 1 x 38 x 38
    ...
    def backward_G(self):
        ...
        self.loss_DiceA = self.calculate_dice_loss(self.seg_A, self.real_A_mask)
        self.loss_G = self.loss_G_GAN + loss_NCE_both + self.loss_DiceA 
